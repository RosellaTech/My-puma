      ...
      <div className="bg-black text-white border-none py-2">
        <div className="hero-content">
          ...
          <div className="flex items-center justify-center">
            ...
            <a
              href="https://prod.storelocator.puma.com/index.html#/map?"
              target="_blank"
              className=" text-[13px] lg:text-[16px]flex items-center justify-center bg-none text-white border-b-1 border-gray-100 font-thin mb-2"
            >
              FIND A PUMA STORE
            </a>
          </div>
        ...
        <div className="relative w-full">
          ...
          <div className="absolute top-1/2 left-8 transform -translate-y-1/2 text-white">
            <h2 className="lg:text-3xl font-bold leading-tight">
              SPEEDCAT <br />
              <span className=" lg:text-lg font-light">WORN BY ROSE</span>
            </h2>
            ...
            <a
              href="https://prod.storelocator.puma.com/index.html#/map?"
              target="_blank"
              className="mt-4 text-[13px] lg:text-[16px] text-white border-b border-gray-100 font-thin"
            >
              FIND A PUMA STORE
            </a>
          </div>
